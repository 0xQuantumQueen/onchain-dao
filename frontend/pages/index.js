              ...
              {p.deadline.getTime() > Date.now() && !p.executed ? (
                <div className={styles.flex}>
                  <button
                    ...
                    onClick={() => voteForProposal(p.proposalId, "0")}
                  >
                    Vote Yay
                  </button>
                  <button
                    className={styles.button2}
                    onClick={() => voteForProposal(p.proposalId, "1")}
                  >
                    Vote Nay
                  </button>
                </div>
        ...
        <div>
          ...
          <div className={styles.description}>
            ...
            {daoBalance.data && (
              <>
                Treasury Balance:
                {formatEther(daoBalance.data.value).toString()} formatEther
              </>
            )}
            <br />
          ...
          {renderTabs()}
          {/*Display additional withdrawn button if connected wallet is owner */}
